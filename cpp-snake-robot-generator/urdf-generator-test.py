...
def writeHeaderLinks():
	...
	ret = ret + '\t<link name=\"link_2\">\n\t\t<origin xyz=\"0 0 '+str(length/2)+'\" rpy=\"0 0 0\"/>\n\t\t<collision>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\"/>\n\t\t\t<geometry>\n\t\t\t\t<cylinder length=\"'+str(length)+'\" radius=\"'+str(radius)+'\"/>\n\t\t\t</geometry>\n\t\t</collision>\n\t\t<visual>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\"/>\n\t\t\t<geometry>\n\t\t\t\t<cylinder length=\"'+str(length)+'\" radius=\"'+str(radius)+'\"/>\n\t\t\t</geometry>\n\t\t</visual>\n\t\t<inertial>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\" rpy=\"0 0 0\"/>\n\t\t\t<mass value=\"0.159\"/>\n\t\t\t<inertia ixx=\"0.000057969\" ixy=\"0.0\" ixz=\"0.0\" iyy=\"0.000057969\" iyz=\"0.0\" izz=\"0.000049687\"/>\n\t\t</inertial>\n\t</link>'
	return ret

def writeHeaderJoints():
	ret = '\t<joint name=\"fixed\" type=\"fixed\">\n\t\t<parent link=\"world\"/>\n\t\t<child link=\"base_link\"/>\n\t</joint>\n\t<joint name=\"joint_1\" type=\"revolute\">\n\t\t<limit effort=\"1000.0\" lower=\"-1.57075\" upper=\"1.57075\" velocity=\"1\"/>\n\t\t<parent link=\"base_link\"/>\n\t\t<child link=\"link_2\"/>\n\t\t<origin xyz=\"0 0 '+str(length/2)+'\"/>\n\t\t<axis xyz=\"0 1 0\"/>\n\t</joint>'
	return ret

def writeLinks(idx):
	if (idx % 2 == 0):
		ret = '\t<link name=\"link_'+str(idx+1)+'\">\n\t\t<origin xyz=\"0 0 '+str(length/2)+'\" rpy=\"0 0 0\"/>\n\t\t<collision>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\"/>\n\t\t\t<geometry>\n\t\t\t\t<cylinder length=\"'+str(length)+'\" radius=\"'+str(radius)+'\"/>\n\t\t\t</geometry>\n\t\t</collision>\n\t\t<visual>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\"/>\n\t\t\t<geometry>\n\t\t\t\t<cylinder length=\"'+str(length)+'\" radius=\"'+str(radius)+'\"/>\n\t\t\t</geometry>\n\t\t</visual>\n\t\t<inertial>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\" rpy=\"0 0 0\"/>\n\t\t\t<mass value=\"0.159\"/>\n\t\t\t<inertia ixx=\"0.000057969\" ixy=\"0.0\" ixz=\"0.0\" iyy=\"0.000057969\" iyz=\"0.0\" izz=\"0.000049687\"/>\n\t\t</inertial>\n\t</link>'
	else:
		ret = '\t<link name=\"link_'+str(idx+1)+'\">\n\t\t<origin xyz=\"0 0 '+str(length/2)+'\" rpy=\"0 0 0\"/>\n\t\t<collision>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\"/>\n\t\t\t<geometry>\n\t\t\t\t<cylinder length=\"'+str(length)+'\" radius=\"'+str(radius)+'\"/>\n\t\t\t</geometry>\n\t\t</collision>\n\t\t<visual>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\"/>\n\t\t\t<geometry>\n\t\t\t\t<cylinder length=\"'+str(length)+'\" radius=\"'+str(radius)+'\"/>\n\t\t\t</geometry>\n\t\t</visual>\n\t\t<inertial>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\" rpy=\"0 0 0\"/>\n\t\t\t<mass value=\"0.159\"/>\n\t\t\t<inertia ixx=\"0.000057969\" ixy=\"0.0\" ixz=\"0.0\" iyy=\"0.000057969\" iyz=\"0.0\" izz=\"0.000049687\"/>\n\t\t</inertial>\n\t</link>'
	return ret
...
def writeEELink(idx):
	if (idx % 2 == 0):	
		ret = '\t<link name=\"link_EE\">\n\t\t<origin xyz=\"0 0 '+str(length/2)+'\" rpy=\"0 0 0\"/>\n\t\t<collision>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\"/>\n\t\t\t<geometry>\n\t\t\t\t<cylinder length=\"'+str(length)+'\" radius=\"'+str(radius)+'\"/>\n\t\t\t</geometry>\n\t\t</collision>\n\t\t<visual>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\"/>\n\t\t\t<geometry>\n\t\t\t\t<cylinder length=\"'+str(length)+'\" radius=\"'+str(radius)+'\"/>\n\t\t\t</geometry>\n\t\t</visual>\n\t\t<inertial>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\" rpy=\"0 0 0\"/>\n\t\t\t<mass value=\"0.159\"/>\n\t\t\t<inertia ixx=\"0.000057969\" ixy=\"0.0\" ixz=\"0.0\" iyy=\"0.000057969\" iyz=\"0.0\" izz=\"0.000049687\"/>\n\t\t</inertial>\n\t</link>'
	else:
		ret = '\t<link name=\"link_EE\">\n\t\t<origin xyz=\"0 0 '+str(length/2)+'\" rpy=\"0 0 0\"/>\n\t\t<collision>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\"/>\n\t\t\t<geometry>\n\t\t\t\t<cylinder length=\"'+str(length)+'\" radius=\"'+str(radius)+'\"/>\n\t\t\t</geometry>\n\t\t</collision>\n\t\t<visual>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\"/>\n\t\t\t<geometry>\n\t\t\t\t<cylinder length=\"'+str(length)+'\" radius=\"'+str(radius)+'\"/>\n\t\t\t</geometry>\n\t\t</visual>\n\t\t<inertial>\n\t\t\t<origin xyz=\"0 0 '+str(length/2)+'\" rpy=\"0 0 0\"/>\n\t\t\t<mass value=\"0.159\"/>\n\t\t\t<inertia ixx=\"0.000057969\" ixy=\"0.0\" ixz=\"0.0\" iyy=\"0.000057969\" iyz=\"0.0\" izz=\"0.000049687\"/>\n\t\t</inertial>\n\t</link>'
	return ret

def writeEEJoint(idx):
	if (idx % 2 == 0):
...
for i in xrange(2,dof):
	print writeLinks(i)
print writeEELink(dof)

print writeHeaderJoints()
for i in xrange(2,dof):
	print writeJoints(i)
print writeEEJoint(dof)
